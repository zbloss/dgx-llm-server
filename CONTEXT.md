...
The model stack has changed several times; see `docs/adr/` for full rationale. Current state (ADR 0017, accepted 2026-09-16, unverified pending deploy) is **SGLang serving a single model, `qwen3.8-flash-next` (`nvidia/Qwen3.8-Flash-Next-NVFP4`), with its PLE table offloaded to local NVMe and NEXTN speculative decoding enabled**.
